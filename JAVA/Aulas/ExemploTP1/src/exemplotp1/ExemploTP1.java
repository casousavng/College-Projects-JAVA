    ...
    // Engenharia Informatica 2 Semestre 1 Ano (2022/2023)  //
    //                                                      //
    //////////////////////////////////////////////////////////
...
public class ExemploTP1 {
    ...
    public static void dados(){
        ...
        // sub programa que escreve o aviso que é necessario inserir os dados para depois escalonar o atleta
    ...
    public static void main(String[] args) {
        ...
        // menu inicial para inserçao de dados na opçao 1
        // escolha da categoria do atleta entre as opçoes 2 e 7
        // opcao 8 para sair do programa
       ...
       switch(opcao){
           ...
           case 1:
               // adicionei a seguinte condição para que teste se o utilizador ja tinha inserido os valores do atleta e ano corrente uma vez para que apos
               // a inserçao dos mesmos, este apenas possa escolher a categoria do atleta e nao voltar a inserir valores novamente ate acertar a categoria
               if (anoAtleta != 0 && anoCorrente != 0){
                   ...
                   do{
                        // pedido de inserçao do ano de nascimento do atleta com a condiçao de ser igual ou superior a 1956 
                        // e igual ou inferior a 2014 e se nao for, aguarda a inserçao correta avisando do erro
                   ...
                   do{
                        // pedido de inserçao do ano corrente para poder ser usado no calculo do escalao do atleta e na idade
                   ...
                   break;
           case 2:
               // primeiro verifica se os dados (ano do atleta e ano corrente) foram inseridos chamando o sub programa dados escreve o aviso
               if ((anoAtleta == 0) || (anoCorrente == 0)){
                   dados();
                   break;
               }
                   ...
                   if (anoCorrente - anoAtleta >= 7 && anoCorrente - anoAtleta <= 11 ) {
                       ...
                       System.out.println("Escalonar novo atleta???"); // gera questao ao utlizador se pretende inserir novo atleta
                       do{
                       ...
                       if (continuar == 1){
                           System.out.println("Insira os dados do novo Atleta."); // zera os dados anteriores inseridos e volta ao inicio do ciclo
                           anoCorrente = 0; 
                           anoAtleta = 0;
                       }
                       if (continuar == 2)  { 
